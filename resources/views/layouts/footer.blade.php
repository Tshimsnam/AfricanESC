        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-10 mb-12">
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        <li><a href="#" class="text-green-300 hover:text-white transition duration-300">Potagers urbains</a></li>
                        <li><a href="#" class="text-green-300 hover:text-white transition duration-300">Kits solaires</a></li>
                        <li><a href="#" class="text-green-300 hover:text-white transition duration-300">Ateliers zéro déchet</a></li>
                        <li><a href="#" class="text-green-300 hover:text-white transition duration-300">Formations</a></li>
                        <li><a href="#" class="text-green-300 hover:text-white transition duration-300">Consulting</a></li>
                    </ul>
                </div>
