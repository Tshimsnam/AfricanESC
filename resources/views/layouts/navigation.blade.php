    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-20">
            ...
            <div class="hidden md:flex items-center space-x-8">
                ...
                <x-nav-link href="#missions" :active="request()->is('*missions*')">Services</x-nav-link>
                ...
                <a href="#don"
                    class="ml-4 px-6 py-2 bg-gradient-to-r from-green-500 to-green-600 text-white rounded-full shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition duration-300 flex items-center">
                    <i class="fas fa-seedling mr-2"></i> Download the Brochure
                </a>
            </div>
