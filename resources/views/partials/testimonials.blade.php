<section class="py-20 bg-green-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-4xl mx-auto">
            ...
            <div class="bg-white rounded-xl shadow-md hover:shadow-xl transition duration-500 transform hover:-translate-y-2 p-8 text-center"
                ...
                <div class="relative mb-6">
                    <img src="{{ asset('images/director.jpg') }}"
                        alt="JEAN-DIDIER MUALABA - Communication & Partenariats"
            ...
            <div id="jeandidierModal"
                class="fixed hidden inset-0 bg-black bg-opacity-80 z-50 flex items-center justify-center p-4">
                <div class="bg-white rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
                    <div class="relative p-8">
                        <button onclick="closeTeamModal('jeandidierModal')"
                        ...
                        <div class="text-center mb-6">
                            ...
                            <p class="text-green-600 font-semibold text-lg mb-4"
                                data-translate="team.comm.modal.position">Directeur</p>
                        </div>

                        <div class="prose prose-lg max-w-none text-gray-700">
                            <p class="mb-4" data-translate="team.comm.modal.description1">
                                Jean-Didier MUALABA est un praticien engagé du développement communautaire et
                                environnemental avec de nombreuses années d'expérience dans le développement et le
                                monitoring de la conformité environnementale avec la législation actuelle en matière
                                d'émissions, de pollution, d'empreinte carbone et de gestion des déchets.
                            </p>
                            ...
                            <ul class="list-disc list-inside mb-4 ml-4">
                                <li data-translate="team.comm.modal.skill1">Expérience considérable dans la formulation
                                    de politiques environnementales, procédures et bonnes pratiques</li>
                                <li data-translate="team.comm.modal.skill2">Réalisation d'études d'impact
                                    environnemental et mise en œuvre de solutions durables</li>
                                <li data-translate="team.comm.modal.skill3">Monitoring et revue des performances
                                    environnementales</li>
                                <li data-translate="team.comm.modal.skill4">Implication des communautés locales dans les
                                    processus de régénération et développement</li>
                            </ul>
                            ...
                            <div class="bg-green-50 rounded-lg p-4 mt-6">
                                <h4 class="font-semibold text-green-800 mb-2"
                                    data-translate="team.comm.modal.expertise_title">Domaines d'expertise :</h4>
                                <div class="flex flex-wrap gap-2">
                                    <span class="bg-green-100 text-green-800 px-3 py-1 rounded-full text-sm"
                                        data-translate="team.comm.modal.expertise1">Conformité Environnementale</span>
                                    <span class="bg-green-100 text-green-800 px-3 py-1 rounded-full text-sm"
                                        data-translate="team.comm.modal.expertise2">Développement Communautaire</span>
                                    <span class="bg-green-100 text-green-800 px-3 py-1 rounded-full text-sm"
                                        data-translate="team.comm.modal.expertise3">Gestion des Déchets</span>
                                    <span class="bg-green-100 text-green-800 px-3 py-1 rounded-full text-sm"
                                        data-translate="team.comm.modal.expertise4">Émissions & Pollution</span>
                                    <span class="bg-green-100 text-green-800 px-3 py-1 rounded-full text-sm"
                                        data-translate="team.comm.modal.expertise5">Audit Environnemental</span>
                                    <span class="bg-green-100 text-green-800 px-3 py-1 rounded-full text-sm"
                                        data-translate="team.comm.modal.expertise6">Engagement des Parties
                                        Prenantes</span>
                                </div>
                            </div>
                        </div>
            ...
            <div class="bg-white rounded-xl shadow-md hover:shadow-xl transition duration-500 transform hover:-translate-y-2 p-8 text-center"
                ...
                <p class="text-gray-600 mb-4 line-clamp-3" data-translate="team.ceo.short_desc">
                    Freddy Shamwana est Directeur Exécutif chez AES CONSULTING RDC et Royaume-Uni, responsable du
                    développement des affaires, de la gouvernance environnementale et sociale et des politiques de
                    durabilité...
                </p>
            ...
            <div id="freddyModal"
                ...
                <div class="bg-white rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
                    <div class="relative p-8">
                        <button onclick="closeTeamModal('freddyModal')"
                            class="absolute top-4 right-4 text-gray-500 hover:text-gray-700 text-2xl">
                            <i class="fas fa-times"></i>
                        </button>

                        <div class="text-center mb-6">
                            <img src="{{ asset('images/executif_director.jpg') }}"
                                alt="FREDDY SHAMWANA - Directeur Exécutif"
                                class="w-40 h-40 rounded-full mx-auto object-cover border-4 border-green-100 mb-4">
                            <h3 class="text-3xl font-bold text-gray-900 mb-2" data-translate="team.ceo.modal.title">
                                FREDDY SHAMWANA</h3>
                            <p class="text-green-600 font-semibold text-lg mb-4"
                                data-translate="team.ceo.modal.position">Directeur Exécutif</p>
                        </div>

                        <div class="prose prose-lg max-w-none text-gray-700">
                            <p class="mb-4" data-translate="team.ceo.modal.description1">
                                Freddy Shamwana est Directeur Exécutif chez AES CONSULTING en République Démocratique du
                                Congo et au Royaume-Uni. Il est responsable du développement des affaires, de la
                            ...
                            <div class="bg-green-50 rounded-lg p-4 mt-6">
                                <h4 class="font-semibold text-green-800 mb-2"
                                    data-translate="team.ceo.modal.expertise_title">Domaines d'expertise :</h4>
                                <div class="flex flex-wrap gap-2">
                                    <span class="bg-green-100 text-green-800 px-3 py-1 rounded-full text-sm"
                                        data-translate="team.ceo.modal.expertise1">Gouvernance ESG</span>
                                    <span class="bg-green-100 text-green-800 px-3 py-1 rounded-full text-sm"
                                        data-translate="team.ceo.modal.expertise2">Développement Durable</span>
                                    <span class="bg-green-100 text-green-800 px-3 py-1 rounded-full text-sm"
                                        data-translate="team.ceo.modal.expertise3">Industrie Minière</span>
                                    <span class="bg-green-100 text-green-800 px-3 py-1 rounded-full text-sm"
